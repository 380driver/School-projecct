            ...
            {RISKS.map((risk) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`bg-slate-900/50 backdrop-blur-md border rounded-xl p-6 transition-all group ${
                     isSubmitted && !isMatch ? 'border-red-500/30' : 'border-slate-700/50 hover:border-cyan-500/30'
                  }`}
                >

            ...
            <div className="max-w-7xl mx-auto w-full">
                ...
                >
                    <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20">
                        ...
                        <span className="text-cyan-400 font-mono tracking-wider text-sm uppercase">Historical Timeline</span>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        {/* Vertical Line */}
                        <div className="absolute left-8 top-0 bottom-0 w-[2px] bg-slate-800 hidden md:block" />
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <span className={`font-mono text-sm font-bold tracking-wider transition-colors ${isActive ? 'text-cyan-400' : 'text-slate-500 group-hover:text-cyan-500/70'
                                                }`}>
                                                {year}
                                            </span>
                                            <h3 className={`text-lg font-bold transition-colors ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-slate-200'
                                                }`}>
                                                {event.title.split(':')[1] || event.title}
                                            </h3>
                                        </div>

                                        <ChevronRight className={`w-5 h-5 transition-all duration-300 ${isActive ? 'text-cyan-400 opacity-100 translate-x-0' : 'text-slate-600 opacity-0 -translate-x-4 group-hover:opacity-50'
                                            }`} />
                                    </motion.div>
                                );
                            })}
                    ...
                    <div className="relative h-[400px] md:h-[500px]">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="h-full bg-gradient-to-br from-slate-900/90 to-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 md:p-12 shadow-2xl flex flex-col justify-center relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <span className="inline-block px-3 py-1 rounded bg-cyan-950/50 border border-cyan-500/20 text-cyan-400 font-mono text-sm mb-6">
